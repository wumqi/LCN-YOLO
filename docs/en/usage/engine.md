...
For further customization like changing the `loss function` or adding a `callback`, you can reference our [Callbacks Guide](callbacks.md).
...
For further details on callback events and entry points, refer to our [Callbacks Guide](callbacks.md).
